...
<?php require_once('template-parts/sidebar.php'); ?>
      ...
      <div class="main-panel">        
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12">
			    <h1 class="card-title ml10">You can manage delivery boys</h1>
                <a class="btn btn-info" href="delivery-boys.php">Manage Delivery Boys</a><br />
            </div>
              ...
              <div class="card">
                <div class="card-body">
					...
					<form class="forms-sample" action="" method="POST">
						...
						<button type="submit" name="add_delivery_boy" class="btn btn-primary mr-2">Add Delivery Boy</button>
